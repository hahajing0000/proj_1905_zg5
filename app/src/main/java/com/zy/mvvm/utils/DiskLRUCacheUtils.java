 ...
 * @CreateDate: 2021/11/19 11:02
 * @UpdateUser: 张跃
 * @UpdateDate: 2021/11/19 11:02
 * @UpdateRemark:
 * @Version: 1.0
 */
public final class DiskLRUCacheUtils<V> {
    ...
    private DiskLRUCacheUtils(){
         ...
         * 如下 初始化DiskLruCache
         */
        String diskCachePath = Environment.getExternalStorageDirectory().getAbsolutePath()+ File.separator+"bawei1905";
